 ...
 * @ 수정일        수정자        수정내용
 * @ ----------    ---------    ----------------------------------------
 * @ 2026.04.27    박상진       최초 생성
 * @ 2026.05.06    박상진       문서 데이터 제거 / DB 기반 최근 작성 목록 연결
 * @ 2026.05.07    박상진       문서 유형 REPORT / MINUTES / APPROVAL 정리
 * @ 2026.05.07    박상진       mail 명목 correction 화면으로 정리
 */
