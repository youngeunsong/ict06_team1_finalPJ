...
// 시연용 이미지 파일
import refImage from 'src/assets/images/first_demo/ai-portal_chatbot_main_select-menu.png'
...
// [AI챗봇] 챗봇 메인 - 메뉴 선택 페이지
const ChatbotMainSelectMenu = () => {
...
export default ChatbotMainSelectMenu;