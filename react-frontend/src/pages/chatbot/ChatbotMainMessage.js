...
// 시연용 이미지 파일
import refImage from 'src/assets/images/first_demo/ai-portal_chatbot_main_message.png'
...
// [AI챗봇] 챗봇 메인 - 메시지 작성 페이지
const ChatbotMainMessage = () => {
...
export default ChatbotMainMessage;